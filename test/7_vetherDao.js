...
var BASE = artifacts.require("./Vether.sol");
...
function constructor(accounts) {
    ...
    it("constructor events", async () => {
        ...
        // await base.addExcluded(router.address);
    });
}
...
async function createPool() {
    it("It should deploy Eth Pool", async () => {
        ...
        assert.equal(_.BN2Str(await base.balanceOf(poolETH.address)), _.BN2Str(_.one * 10 * 0.999), 'base balance')
